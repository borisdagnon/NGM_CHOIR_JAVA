    ...
    $('#dropDwn_Annee').on("change",function () {
        traitement();
    });
    $('#dropDwn_Theme').on("change",function () {
        traitement();
    });
    ...
    function traitement() {
        ...
        filterDataRequest.done(function (data) {
            ...
            $html="";
            $affiche="";
            $base=(data.nombreVideo+data.nombreEnseignement);
            ...
            for($i=1;$i<=$add;$i++){
                /*alert($i)*/
                $html+='<a href="messages?page='+$i+'" ><button class="ui inverted blue button">'+$i+'</button></a>';

            }
            $html+='<script src="/resources/js/pagination_ajax.js"></script>';
